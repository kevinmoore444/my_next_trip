...
import org.example.data.repositories.AppUserRepository;
...
public class AppUserService implements UserDetailsService {
    ...
    private Result<AppUser> validate(String username, String password) {
        ...
        if (!isValidPassword(password)) {
            result.addErrorMessage("Password must be at least 8 character and contain a digit, a letter, and a non-digit/non-letter");
        }
        return result;
    }
